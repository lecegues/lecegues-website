        ...
        <section className="text-black">
            <div className="md:grid md:grid-cols-2 gap-8 xl:gap-16 items-center py-8 px-4 sm:py-16 xl:px-16">
                ...
                <div className="font-sans">
                    ...
                    <h2 className="text-4xl font-mono font-bold text-[#37444B] mb-4"> <span className="border-b-4 pr-3 border-[#4a90e2]"> About Me</span> </h2>
                    ...
                    <div className="flex flex-row mt-8">
                        ...
                        <span className="mr-3 font-semibold hover:text-black text-gray-200 border-b border-purple-500">Skills</span>
                        <span>Education</span>
